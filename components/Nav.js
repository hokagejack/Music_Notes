...
export default function Nav() {
  ...
  return (
    ...
    {/* link to homepage */}
      ...
      //join rendering based on auth status
      <ul className="flex items-center gap-10">
        {!user && (
          // if user not logged in show a "Join Now" button linking to the login page
        ...
        {user && (
          // if user is logged in, show buttons to post and a profile image linking to dashboard
          <div className="flex items-center gap-6 px-10">
            ...
            <Link href="/dashboard" >
              <img 
                src={user.photoURL}  // display user's profile picture from Firebase auth
